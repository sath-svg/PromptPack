export default function MarketplaceConnectReturnPage() {
  return (
    <main className="min-h-screen flex items-center justify-center bg-neutral-50 px-6">
      <div className="max-w-md text-center">
        ...
        <p className="text-neutral-600 mb-6">
          Return to the Skillset desktop app and tap{' '}
          <span className="font-medium text-neutral-900">Refresh status</span>{' '}
          in the New Listing wizard to confirm payouts are enabled.
        </p>
        <a
          href="/"
