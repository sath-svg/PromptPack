        ...
        <p>
          ...
          <span className="tooltip-wrap">
            <span
              ...
              data-tooltip="You can also use Ctrl+Shift+S (Cmd+Shift+S on Mac) while in the prompt box to save it to the extension."
              aria-label="You can also use Ctrl+Shift+S (Cmd+Shift+S on Mac) while in the prompt box to save it to the extension."
              tabIndex={0}
            >
              ℹ️
            </span>
