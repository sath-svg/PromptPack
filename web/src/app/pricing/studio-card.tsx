  ...
  return (
    <div
      style={{
        ...
        background: "linear-gradient(var(--bg), var(--bg)) padding-box, linear-gradient(135deg, #8b5cf6, #d946ef) border-box",
        textAlign: "left",
        position: "relative",
        display: "flex",
    ...
    >
      ...
      >
        ...
        <li>✓ <span style={{ background: "linear-gradient(135deg, #8b5cf6, #d946ef)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent", fontWeight: "600" }}>MCP server access</span> <span style={{ fontSize: "0.7rem", background: "#8b5cf6", color: "white", padding: "0.1rem 0.3rem", borderRadius: "4px", marginLeft: "0.25rem" }}>SOON</span></li>
