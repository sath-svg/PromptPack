...
/**
 * PromptPack brand theme for pro-only LLMs
 * Grey background + purple accent - consistent across all pro LLMs
 */
export const promptPackTheme = {
  bg: "#1a1a2e",
  text: "#e0e0e0",
  border: "rgba(139, 92, 246, 0.3)",
  shadow: "0 4px 12px rgba(0, 0, 0, 0.4)",
  accent: "#8b5cf6", // PromptPack purple
