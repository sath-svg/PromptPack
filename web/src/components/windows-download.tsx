...
const FILES: Record<Arch, { exe: string; msi: string; label: string; size: string }> = {
  x64: {
    exe: "/downloads/Skillset_1.3.0_x64-setup.exe",
    msi: "/downloads/Skillset_1.3.0_x64_en-US.msi",
    label: "x64 (64-bit Intel / AMD)",
    size: "~10 MB",
  },
  arm64: {
    exe: "/downloads/Skillset_1.3.0_arm64-setup.exe",
    msi: "/downloads/Skillset_1.3.0_arm64_en-US.msi",
